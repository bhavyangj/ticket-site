...
export const ProductDetailView = () => {
  ...
  return (
    <div className="w-full pb-[10vw] flex flex-col">
      <SpaceY />
      <SpaceY />
      ...
      <div className="w-full flex">
        ...
        <div className="w-4/5 flex flex-col font-poppins text-sm">
          ...
          <span className="ml-5">현장 판매가는 시즌별에 따라 상이합니다.</span>
          <SpaceY />
          ...
          <SpaceY />
          <span className="ml-5">
            *세금과 티켓 발권 비용 등이 모두 포함된 최종 가격이며, 타미스는
            부수적인 세금이나 비용을 청구하지 않습니다.
          </span>
          <span className="ml-5">
      ...
      <div className="w-full flex">
        ...
        <div className="w-4/5 flex flex-col font-poppins text-sm">
          ...
          <span className="">한국 지사: 월-금요일 오전 9:00 ~ 오후 6:00</span>
          <SpaceY />
          ...
          <span className=""> 타미스 카카오톡 채널: @타미스 (문의하기)</span>
        </div>
      </div>
      <SpaceY />
      <SpaceY />
      ...
      <div className="w-full flex">
        ...
        <div className="w-4/5 flex flex-col font-poppins text-sm">
          ...
          <span className="">20 W 34th St, New York, NY 10001</span> <SpaceY />
          <span className="">운영시간 </span>
          <span className="">
      ...
      <div className="w-full flex">
        ...
        <div className="w-4/5 flex flex-col font-poppins text-sm">
          ...
          <span className="">
            방문 희망 날짜와 시간, 대표자 영문 성함을 타미스 카카오톡 채널 및
            이메일로 요청하시면 E-티켓을 발송해 드립니다.
          </span>
          <span className="">
            E-티켓에 있는 예약날짜와 시간에 맞춰 방문해 주세요.
          </span>
          <span className="">
            선셋타임 입장을 원하시는 경우에는 1인당 $10의 금액을 지불하시고
            이용하실 수 있습니다.
          </span>
        </div>
      </div>
      ...
      <div className="w-full flex">
        ...
        <div className="w-4/5 flex flex-col font-poppins text-sm">
          <span className="">
            구매 시 기재하신 이메일로 E-티켓이 발송됩니다. 반드시 방문 전에
            E-티켓을 확인하시고 확인이 불가능할 경우 타미스 카카오톡 채널 또는
            이메일 (service@tamice.com) 로 문의해 주세요.
          </span>
          <span className="">
            운영시간은 시기나 특정 기념일에 따라 변경될 수 있으니 방문 전에
            반드시 공식 홈페이지에서 확인해 주세요.
          </span>
          <span className="">
            해당 E-티켓은 1회 입장만 가능하며, 재사용은 불가능 합니다. 입장 후
            관람 시간의 제한은 없습니다.
          </span>
          <span className="">
            선셋타임 입장을 원하시는 경우에는 현장에서 1인당 $10의 금액을
      ...
      <div className="w-full font-poppins text-xl flex" id="refund">
        <img width={25} src={staticFiles.icons.refund} className="mr-5" /> 취소
        및 환불규정 (Refund Policy)
      </div>
      <SpaceY />
      <div className="w-full flex">
        <div className="w-1/5" />
