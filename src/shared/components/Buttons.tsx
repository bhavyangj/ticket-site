...
export const MainButton: React.FC<{
  ...
  const className = `font-poppins font-medium text-white bg-blue py-2 ${containerClassName}`;
  const disabledClass = `font-poppins font-medium text-white bg-blue py-2 cursor-not-allowed ${containerClassName}`;
  return (
    <button
      className={disabled ? disabledClass : className}
      onClick={() => !disabled && onClick()}
...
export const SecondaryButton: React.FC<{
  ...
  const className =
    "font-poppins font-medium text-white bg-gray w-[300px] py-2";
  const disabledClass =
    "font-poppins font-medium text-white bg-gray w-[300px] py-2 cursor-not-allowed";
  return (
    <button
      className={disabled ? disabledClass : className}
      onClick={() => !disabled && onClick()}
